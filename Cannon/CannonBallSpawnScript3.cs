...
public class CannonBallSpawnScript3 : MonoBehaviour {
...
//		{
//			GUI.skin = TextUI;
//			GUI.Label (new Rect (Screen.width/1.225f, Screen.height/9f, 100, 40), "" + timeCD.ToString("F0"));
//			//GUI.Box(new Rect (Screen.width-140, Screen.height/2 +220, 100, 25)," ");
//		} 
//		else if (timeCD <= 0)
//		{
//			CoolD = false;
