...
public class dictatorControlScript1 : MonoBehaviour {
	
	public bool speedUpTrigger1=false;
...
//		if ((Input.GetKey ("[1]") & cdData.speedUpCooldown<=0)||(Input.GetAxis("LeftJoystickX4")<0&Input.GetButtonDown("X4")&cdData.speedUpCooldown<=0)) 
		if ((Input.GetKey ("[1]") & cdData.speedUpCooldown<=0)||(Input.GetAxis("LeftJoystickX4")<-0.75f&&cdData.speedUpCooldown<=0))
		{
